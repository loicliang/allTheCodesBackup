...
int main(int argc,char *argv[])
{
    ...
    if(modeltype==isotropic or modeltype==j2)
    {
        ...
        test.HuyenMorel_Analysis(0.198,0.00233,535,6);
	    
	    test.DangVan_Analysis(aDV,s,Depth,Radius);
	    test.Matake_Analysis(aM,s,Depth,Radius);
	    test.Papadopoulos_Analysis(aPap,s,Depth,Radius);
	    test.HuyenMorel_Analysis(0.198,0.00233,535,6,Depth,Radius);
	...
	if(modeltype==cubic)
	{
        ...
        test.cubHuyenMorel_Analysis(0.198,0.00233,535,6);
	    test.Fin_Grains();
	}
	...
	if(modeltype==crystal)
	{
        ...
        test.grainHuyenMorel_Analysis(0.198,0.00233,535,6);
	    test.Fin_Grains();
